...
class StreetlampManager
{
    ...
    constructor()
    {
        this.streetlamps = [
            ...
            //platform 5/8
            (new Streetlamp( new THREE.Vector3(22,-4, -70), new THREE.Vector3(0, 360/360*Math.PI, 0),new THREE.Vector3(0.4, 1, 0.8))),
            (new Streetlamp( new THREE.Vector3(18.5,-4, -155), new THREE.Vector3(0, 360/360*Math.PI, 0),new THREE.Vector3(0.4, 1, 0.8))),
        ];
    }
